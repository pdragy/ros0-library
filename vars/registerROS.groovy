def call(def docker_tag, def build_deps, def run_deps) {
    ...
    def test_cmd =  ros_version == "2" ? "colcon test --event-handlers console_direct+ --merge-install --pytest-args \"-m 'not linter'\""  : "catkin_make_isolated --merge --source . --catkin-make-args run_tests"
